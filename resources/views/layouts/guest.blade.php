...
<body class="antialiased h-screen overflow-hidden bg-black">
    <!-- Split Layout Container -->
    <div class="flex w-full h-full">

        <!-- Left Side: Image / Brand (Hidden on mobile) -->
        <div class="hidden lg:flex w-1/2 relative bg-gray-900 border-r border-gray-800">
            <!-- Background Image -->
            ...
            <div class="relative z-10 w-full flex flex-col justify-between p-12">
                ...
                <div class="flex items-center gap-3">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/BMW.svg/2048px-BMW.svg.png"
                        alt="BMW Logo" class="h-10 w-auto text-white filter drop-shadow-md">
                ...
                <div class="mb-10">
                    <h1 class="text-5xl font-bold text-white mb-4 leading-tight">
                        Excelencia en <br>Cada Detalle
                    </h1>
                    <p class="text-gray-300 text-lg max-w-md border-l-4 border-blue-600 pl-4">
                        Accede a la plataforma de gestión de servicios más avanzada para el cuidado de tu vehículo.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center bg-[#0a0a0a] text-white p-8 relative">

            <!-- Mobile Background (Subtle) -->
            <div
                class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1555215695-3004980ad54e?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-10 lg:hidden">
            </div>
