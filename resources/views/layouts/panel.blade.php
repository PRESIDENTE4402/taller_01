        ...
        <div class="flex-1 overflow-y-auto py-4 sidebar-scroll">
            <nav class="space-y-1 px-3">
                ...
                <a href="{{ route('panel.clientes.index') }}"
                    class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('panel.clientes.*') ? 'sidebar-active' : 'sidebar-item text-slate-400' }} transition-colors">
