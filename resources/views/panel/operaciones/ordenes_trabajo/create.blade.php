...
<<<<<<< HEAD
    ...
    <form action="{{ isset($orden) ? route('panel.operaciones.ordenes_trabajo.update', $orden->id) : route('panel.operaciones.ordenes_trabajo.store') }}"
        ...
        <form action="{{ route('panel.operaciones.ordenes_trabajo.store') }}" method="POST" id="ordenForm" class="space-y-6"
            enctype="multipart/form-data">
            @csrf
            >>>>>>> 796683be2ba285fabcc49e18d22c9c1fd548938e

            <!-- Header: Datos Generales (Card Similar a la Factura) -->
            <!-- Floating Header Actions (Top Sticky) -->
            <div
                class="sticky top-0 z-[60] -mx-4 sm:-mx-6 px-4 sm:px-6 py-3 bg-white/90 backdrop-blur-md border-b border-blue-100 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 transition-all duration-300">
                <div class="flex items-center gap-3 w-full sm:w-auto">
                    <div
                        class="hidden sm:flex h-10 w-10 bg-blue-900 rounded-lg items-center justify-center text-white shadow-lg">
            ...
            <div class="hidden md:flex items-center gap-0 flex-1 justify-center max-w-xl px-4">
                <a href="#section-datos" class="step-nav group flex flex-col items-center gap-1 active" data-step="datos">
                    <div
                        class="w-8 h-8 rounded-full border-2 border-blue-900 flex items-center justify-center bg-blue-900 text-white transition-all group-hover:scale-110 shadow-md shadow-blue-900/20">
                ...
                <a href="#section-recepcion" class="step-nav group flex flex-col items-center gap-1" data-step="recepcion">
                    <div
                        class="w-8 h-8 rounded-full border-2 border-gray-200 flex items-center justify-center bg-white text-gray-400 transition-all group-hover:border-blue-900 group-hover:text-blue-900 shadow-sm">
                        <i class="fas fa-camera text-xs"></i>
                    </div>
                    <span
                        class="text-[9px] font-black uppercase text-gray-400 tracking-tighter group-hover:text-blue-900">FOTOS</span>
                </a>
                <div class="h-[2px] w-8 bg-blue-100 flex-shrink-0 mb-3"></div>

                <a href="#section-inventario" class="step-nav group flex flex-col items-center gap-1"
                    data-step="inventario">
                    <div
                        class="w-8 h-8 rounded-full border-2 border-gray-200 flex items-center justify-center bg-white text-gray-400 transition-all group-hover:border-blue-900 group-hover:text-blue-900 shadow-sm">
                        <i class="fas fa-clipboard-list text-xs"></i>
                    </div>
                    <span
                        class="text-[9px] font-black uppercase text-gray-400 tracking-tighter group-hover:text-blue-900">INVENTARIO</span>
                </a>
                <div class="h-[2px] w-8 bg-blue-100 flex-shrink-0 mb-3"></div>
                ...
                <a href="#section-falla" class="step-nav group flex flex-col items-center gap-1" data-step="falla">
                    ...
                    <span
                        class="text-[9px] font-black uppercase text-gray-400 tracking-tighter group-hover:text-blue-900">FALLA</span>
                </a>
                <div class="h-[2px] w-8 bg-blue-100 flex-shrink-0 mb-3"></div>
                ...
                <a href="#section-danos" class="step-nav group flex flex-col items-center gap-1" data-step="danos">
                    ...
                    <span
                        class="text-[9px] font-black uppercase text-gray-400 tracking-tighter group-hover:text-blue-900">DAÑOS</span>
                </a>
            </div>

            <div class="flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto">
                <button type="button" id="btnLimpiar"
                    class="btn btn-ghost hover:bg-red-50 text-gray-400 hover:text-red-500 btn-xs sm:btn-sm flex gap-2">
                    <i class="fas fa-eraser"></i> <span class="hidden lg:inline">Limpiar</span>
                </button>

                <div class="flex gap-2">
                    <a href="{{ route('panel.operaciones.ordenes_trabajo.index') }}"
                        class="btn btn-sm sm:btn-md bg-white hover:bg-gray-100 text-gray-500 font-bold px-4 sm:px-6 rounded-xl border-gray-200">
                        Cancelar
                    </a>
                    <button type="submit"
                        class="btn btn-sm sm:btn-md bg-blue-900 hover:bg-blue-800 text-white font-bold px-6 sm:px-10 rounded-xl shadow-lg border-none transform active:scale-95 transition-all">
            ...
            <div
                class="grid grid-cols-1 lg:grid-cols-12 gap-6 pb-20 bg-gradient-to-br from-blue-900 to-slate-900 p-6 rounded-xl">
                                ...
                                <div class="flex flex-col gap-3 relative z-20 bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    <div class="flex items-center justify-between">
                                        <div class="flex gap-2">
                                            ...
                                            <div class="lg:col-span-8 space-y-6">
                                                ...
                                                <div id="section-datos"
                                                    class="scroll-mt-24 card bg-white shadow-lg shadow-blue-900/10 border border-blue-900/20">
                                                    <div class="card-body p-5">
                                                        <h2 class="card-title text-sm font-bold text-gray-500 border-b pb-2 mb-4">
                                                        ...
                                                        <div class="alert alert-warning shadow-sm mb-4 p-3 text-sm">
                                                            ...
                                                            <div class="flex flex-col sm:flex-row gap-4 w-full justify-between items-center">
                                                                ...
                                                                <div class="flex gap-4">
                                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                                        <input type="radio" name="accion_cliente" value="update" checked
                                                                            class="radio radio-xs radio-primary">
                                                                        <span>Actualizar Datos</span>
                                                                    </label>
                                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                                        <input type="radio" name="accion_cliente" value="create"
                                                                            class="radio radio-xs radio-primary">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div class="form-control w-full">
                                                                <label class="label"><span class="label-text font-bold text-blue-900">Nombre
                                                                        Completo</span></label>
                                                                <input type="text" name="new_cliente[nombre]" value="{{ $cliente->nombre_completo }}"
                                                            ...
                                                            <div class="form-control w-full">
                                                                <label class="label"><span
                                                                        class="label-text font-bold text-blue-900">Teléfono</span></label>
                                                                <input type="text" name="new_cliente[telefono]" value="{{ $cliente->telefono }}"
                                                            ...
                                                            <div class="form-control w-full md:col-span-2">
                                                                ...
                                                                <input type="email" name="new_cliente[email]" value="{{ $cliente->email }}"
                                                                    class="input input-sm input-bordered border-yellow-400 w-full focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                                                            </div>
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
                                                            <div class="form-control w-full">
                                                                ...
                                                                <div class="relative">
                                                                    ...
                                                                    <ul id="listClientes"
                                                                        class="absolute z-50 bg-white border border-gray-200 w-full rounded-md shadow-xl max-h-48 overflow-y-auto hidden top-full mt-1">
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="form-control w-full">
                                                            ...
                                                            <div class="form-control w-full">
                                                                <label class="label"><span class="label-text font-bold text-blue-900">Email
                                                                        (Opcional)</span></label>
                                                            ...
                                                            <div class="flex items-end pb-1">
                                                                <p class="text-xs text-gray-500 italic"><i class="fas fa-search"></i> Busque un cliente
                                                                    existente o llene los datos para uno nuevo.</p>
                                                            </div>
                                                            <div class="form-control w-full col-span-1 md:col-span-2">
                                                                <label class="label cursor-pointer justify-start gap-4">
                                                                    ...
                                                                    <input type="checkbox" name="new_cliente[es_empresa]" id="checkEsEmpresa"
                                                                        class="checkbox checkbox-primary" value="1">
                                                                </label>
                                                            </div>
                                                            <div id="divEmpresa" class="hidden form-control w-full col-span-1 md:col-span-2">
                                                                <label class="label"><span class="label-text font-bold text-blue-900">Nombre de la
                                                                        Empresa</span></label>
                                                            ...
                                                            <div class="form-control w-full">
                                                                <label class="label"><span
                                                                        class="label-text font-bold text-blue-900">Dirección</span></label>
                                                ...
                                                <div class="card bg-white shadow-lg shadow-blue-900/10 border border-blue-900/20">
                                                    <div class="card-body p-5">
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                            <div class="form-control w-full">
                                                                <label class="label"><span class="label-text font-bold text-blue-900">Placa
                                                                        (Buscador)</span></label>
                                                                <div class="relative">
                                                                    <input type="text" name="new_vehiculo[placa]" id="inputPlaca"
                                                                        ...
                                                                        value="{{ isset($vehiculo) ? $vehiculo->placa : '' }}" placeholder="P-123ABC"
                                                            ...
                                                            <div class="form-control w-full">
                                                                ...
                                                                <input type="text" name="new_vehiculo[marca]" id="inputMarca" list="listMarcas"
                                                                    class="input input-sm input-bordered border-yellow-400 w-full uppercase focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                                                                    value="{{ isset($vehiculo) ? $vehiculo->marca->nombre : '' }}" placeholder="TOYOTA..."
                                                                    required autocomplete="off" oninput="this.value = this.value.toUpperCase()">
                                                            ...
                                                            <div class="form-control w-full">
                                                                ...
                                                                <input type="text" name="new_vehiculo[modelo]" id="inputModelo" list="listModelos"
                                                                    class="input input-sm input-bordered border-yellow-400 w-full uppercase focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                                                                    value="{{ isset($vehiculo) ? $vehiculo->modelo->nombre : '' }}" placeholder="COROLLA..."
                                                                    required autocomplete="off" oninput="this.value = this.value.toUpperCase()">
                                                            ...
                                                            <div class="form-control w-full">
                                                                ...
                                                                <input type="text" name="new_vehiculo[vin]"
                                                                    class="input input-sm input-bordered border-yellow-400 w-full focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 uppercase"
                                                                    value="{{ isset($vehiculo) ? $vehiculo->vin : '' }}" placeholder="Nº Motor"
                                                                    oninput="this.value = this.value.toUpperCase()">
                                                            </div>
                                                            <div class="form-control w-full">
                                                                ...
                                                                <input type="text" name="color"
                                                                    class="input input-sm input-bordered border-yellow-400 w-full focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                                                                    value="{{ isset($vehiculo) ? $vehiculo->color : '' }}" placeholder="Gris, Rojo..."
                                                                    required>
                                                            </div>
                                                            <div class="form-control w-full">
                                                                <label class="label"><span class="label-text font-bold text-blue-900">Versión
                                                                        (Opcional)</span></label>
                                                ...
                                                <div class="card bg-white shadow-lg shadow-blue-900/10 border border-blue-900/20">
                                                    <div class="card-body p-5">
                                                        ...
                                                        <div class="grid grid-cols-1 gap-4 mt-3">
                                                            <div class="form-control w-full">
                                                                <label class="label"><span class="label-text font-bold text-blue-900">Tipo de
                                                                        Orden</span></label>
                                                                <select name="tipo_orden"
                                                                    class="select select-bordered select-sm border-yellow-400 w-full focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                                                            ...
                                                            <div class="form-control w-full">
                                                                <label class="label"><span
                                                                        class="label-text font-bold text-blue-900">Sucursal</span></label>
                                                                <select name="sucursal_id"
                                                                    class="select select-bordered select-sm border-yellow-400 w-full focus:ring-2 focus:ring-blue-900 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
                                                                    required>
                                                                    <option value="" disabled selected>Seleccione una sucursal</option>
                                                                    @foreach($sucursales as $sucursal)
                                                                    <option value="{{ $sucursal->id }}" {{ (Auth::user()->sucursal_por_defecto_id == $sucursal->id) ? 'selected' : '' }}>
                                                                        {{ $sucursal->nombre }}
                                                                    </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="form-control w-full">
                                                                ...
                                                                @endphp
                                                                <div
                                                                    class="flex items-center px-3 py-1.5 bg-blue-50 border border-blue-100 rounded-lg text-blue-900 font-bold text-sm h-[32px]">
                                                                    <i class="fas fa-store mr-2 text-blue-400"></i>
                                                                    <span class="uppercase">{{ $nombreSucursal }}</span>
                                                                </div>
                                                                <input type="hidden" name="sucursal_id"
                                                                    value="{{ $userSucursal ? $userSucursal->id : '' }}">
                                                            </div>
                                                            @endif
                                                        </div>
                                                        <div class="form-control mt-3">
                                                            <label class="label"><span class="label-text font-bold text-blue-900">Kilometraje
                                                                    Actual</span></label>
                                                            <div class="relative">
                                                ...
                                                <div class="card bg-white shadow-lg shadow-blue-900/10 border border-blue-900/20">
                                                    <div class="card-body p-5 flex flex-col items-center">
                                                        ...
                                                        <div class="w-full max-w-[260px]">
                                                            ...
                                                            <!-- Segmented Bar Bar -->
                                                            <div
                                                                class="relative w-full h-8 bg-gray-100 rounded-lg overflow-hidden flex border border-gray-300 shadow-inner">
                                                                <div id="fuel-seg-1"
                                                                    class="h-full flex-1 border-r border-white/50 bg-gray-200 transition-all duration-300">
                                                                </div>
                                                                <div id="fuel-seg-2"
                                                                    class="h-full flex-1 border-r border-white/50 bg-gray-200 transition-all duration-300">
                                                                </div>
                                                            ...
                                                            <input type="range" name="nivel_combustible_val" id="fuelRange" min="0" max="100" value="50"
                                                                step="1" class="range range-xs range-primary mt-4 w-full text-blue-900" />
                                        ...
                                        <div class="bg-white p-8 rounded-2xl shadow-sm border border-blue-100/50">
                                            <h4 class="font-bold text-gray-700 border-b pb-2 mb-4 flex items-center justify-between">
                                                <span><i class="fas fa-camera text-blue-900 mr-2"></i>FOTOS DE RECEPCIÓN</span>
                                                <span class="text-xs font-normal text-gray-500 bg-gray-100 px-2 py-1 rounded">Mínimo sugerido: 4
                                                    fotos</span>
                                            </h4>

                                            <!-- Controls -->
                                            <div
                                                class="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-6 bg-blue-50/30 p-4 rounded-lg border border-blue-100/50">
                                                <div class="flex gap-2 w-full sm:w-auto">
                                                    <button type="button" id="btnCamera"
                                                        class="btn btn-sm gap-2 bg-blue-900 border-blue-900 hover:bg-blue-800 text-white shadow-md hover:shadow-lg transition-all flex-1 sm:flex-none">
                                                        <i class="fas fa-camera"></i> TOMAR FOTO
                                                    </button>
                                                    <button type="button" id="btnGallery"
                                                        class="btn btn-sm gap-2 btn-outline border-blue-900 text-blue-900 hover:bg-blue-900 hover:text-white shadow-sm hover:shadow-md transition-all flex-1 sm:flex-none">
                                                        <i class="fas fa-images"></i> GALERÍA
                                                    </button>
                                                </div>
                                            ...
                                            <!-- Grid -->
                                            <div id="previewFotosGrid"
                                                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 min-h-[300px]">
                                                <!-- Cards injected via JS -->
                                                <div id="emptyPhotosMsg"
                                                    class="col-span-full flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-blue-100 rounded-2xl py-24 bg-blue-50/20">
                                                    <div class="text-7xl mb-4 text-blue-200"><i class="fas fa-images"></i></div>
                                                    <p class="text-xl font-bold text-blue-900/40 tracking-tight">Cero fotos seleccionadas</p>
                                                    <p class="text-sm font-medium mt-1">Capture o suba imágenes de los 4 ángulos del vehículo</p>
                                                </div>
                                        ...
                                        <div class="space-y-8 pb-12">
                                            ...
                                            <div class="space-y-8">
                                                <!-- Inventory Checklist -->
                                                <div id="section-inventario"
                                                    class="scroll-mt-24 bg-white p-6 rounded-2xl shadow-sm border border-blue-100 flex flex-col">
                                                    <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-6">
                                                        <div>
                                                            <h3 class="font-black text-blue-900 flex items-center gap-2 tracking-tight">
                                                                <i class="fas fa-tasks text-blue-600"></i> INVENTARIO DE RECEPCIÓN
                                                            </h3>
                                                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Estado físico y
                                                                accesorios del vehículo</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-1">
                                                        ...
                                                        <div class="space-y-1">
                                                            ...
                                                            <!-- Documents Special -->
                                                            <div
                                                                class="flex items-center justify-between py-2.5 px-3 border-b border-gray-50 hover:bg-gray-50 transition-colors group">
                                                                <span
                                                                    class="text-xs font-bold text-gray-600 group-hover:text-blue-900 transition-colors uppercase">Documentos</span>
                                                                <div class="flex gap-4">
                                                                    <label class="flex items-center gap-2 cursor-pointer group/sub">
                                                                        <input type="checkbox" name="inv[documentos][original]"
                                                                            class="checkbox checkbox-xs rounded border-gray-300 checkbox-primary">
                                                                        <span
                                                                            class="text-[10px] font-black text-gray-400 group-hover/sub:text-blue-900 mt-0.5">ORIGINAL</span>
                                                                    </label>
                                                                    <label class="flex items-center gap-2 cursor-pointer group/sub">
                                                                        <input type="checkbox" name="inv[documentos][copia]"
                                                                            class="checkbox checkbox-xs rounded border-gray-300 checkbox-primary">
                                                                        <span
                                                                            class="text-[10px] font-black text-gray-400 group-hover/sub:text-blue-900 mt-0.5">COPIA</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            @foreach($items1 as $key => $label)
                                                            <div
                                                                class="flex items-center justify-between py-2 px-3 border-b border-gray-50 hover:bg-gray-50 rounded-lg transition-colors group">
                                                                <span
                                                                    class="text-xs font-bold text-gray-600 group-hover:text-blue-900 transition-colors uppercase">{{ $label }}</span>
                                                                <div class="flex gap-1 bg-gray-100 p-1 rounded-lg">
                                                                    <label
                                                                        class="flex items-center justify-center p-1.5 cursor-pointer rounded-md transition-all has-[:checked]:bg-blue-900 has-[:checked]:text-white hover:bg-white border-none">
                                                                        <input type="radio" name="inv[{{$key}}]" value="1" class="hidden">
                                                                        <span class="text-[10px] font-black px-2">SÍ</span>
                                                                    </label>
                                                                    <label
                                                                        class="flex items-center justify-center p-1.5 cursor-pointer rounded-md transition-all has-[:checked]:bg-gray-400 has-[:checked]:text-white hover:bg-white border-none">
                                                            ...
                                                            <!-- Special Row: Tapicería (3 States) -->
                                                            <div
                                                                class="flex items-center justify-between py-2.5 px-3 border-b border-gray-50 hover:bg-gray-50 rounded-lg transition-colors group">
                                                                <span
                                                                    class="text-xs font-bold text-gray-600 group-hover:text-blue-900 transition-colors uppercase">Estado
                                                                    Tapicería</span>
                                                                <div class="flex gap-1 bg-gray-100 p-1 rounded-lg">
                                                                    <label
                                                                        class="flex items-center justify-center p-1.5 cursor-pointer rounded-md transition-all has-[:checked]:bg-emerald-600 has-[:checked]:text-white hover:bg-white border-none shadow-sm">
                                                                        <input type="radio" name="inv[tapiceria]" value="buena" class="hidden">
                                                                        <span class="text-[9px] font-black px-1">BUENA</span>
                                                                    </label>
                                                                    <label
                                                                        class="flex items-center justify-center p-1.5 cursor-pointer rounded-md transition-all has-[:checked]:bg-amber-500 has-[:checked]:text-white hover:bg-white border-none shadow-sm">
                                                                        <input type="radio" name="inv[tapiceria]" value="regular" class="hidden" checked>
                                                                        <span class="text-[9px] font-black px-1">REGULAR</span>
                                                                    </label>
                                                                    <label
                                                                        class="flex items-center justify-center p-1.5 cursor-pointer rounded-md transition-all has-[:checked]:bg-rose-600 has-[:checked]:text-white hover:bg-white border-none shadow-sm">
                                                        ...
                                                        <div class="space-y-1">
                                                            ...
                                                            @foreach($qtyItems as $key => $label)
                                                            <div
                                                                class="flex items-center justify-between py-3 px-3 border-b border-gray-50 hover:bg-gray-50 rounded-lg transition-colors group">
                                                                <span
                                                                    class="text-xs font-bold text-gray-600 group-hover:text-amber-900 transition-colors uppercase">{{ $label }}</span>
                                                                <div class="flex items-center gap-3">
                                                                    <label class="flex items-center gap-2 cursor-pointer">
                                                                        <input type="checkbox" name="inv[{{$key}}][check]" value="1"
                                                                            class="checkbox checkbox-xs rounded border-gray-300 checkbox-warning toggle-qty"
                                                                            data-target="qty-{{$key}}">
                                                                        <span class="text-[10px] font-black text-gray-400 mt-0.5">¿TRAE?</span>
                                                                    </label>
                                                                    <input type="number" id="qty-{{$key}}" name="inv[{{$key}}][cant]"
                                                                        class="input input-xs input-bordered w-12 text-center hidden font-black text-blue-900 border-amber-200 bg-amber-50"
                                                                        value="0">
                                                                </div>
                                                            </div>
                                                            @endforeach
                                                    ...
                                                    <div class="mt-8 bg-slate-50 p-5 rounded-2xl border border-dashed border-slate-200">
                                                        <label
                                                            class="text-[10px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-2 mb-3">
                                                            <i class="fas fa-comment-alt"></i> Observaciones de Inventario
                                                        </label>
                                                        <textarea name="inventario_observaciones" rows="2"
                                                            class="w-full textarea textarea-sm bg-white border-slate-200 focus:border-blue-900 focus:outline-none text-gray-800 placeholder-slate-300 font-medium"
                                                            placeholder="Escriba detalles como rayones en el tablero, tapicería manchada, etc."></textarea>
                                                    </div>
                                                </div>

                                                <!-- Falla Section -->
                                                <div id="section-falla"
                                                    class="scroll-mt-32 bg-gradient-to-br from-white to-blue-50/30 p-8 rounded-2xl shadow-sm border border-blue-100 flex flex-col gap-4">
                                                    <div class="flex items-center gap-3">
                                                        <div class="h-10 w-10 bg-blue-900 rounded-xl flex items-center justify-center text-white shadow-xl">
                                                            <i class="fas fa-exclamation-triangle"></i>
                                                        </div>
                                                        <div>
                                                            <h3 class="font-black text-blue-900 leading-none">FALLA O MOTIVO DE INGRESO</h3>
                                                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Describa
                                                                detalladamente el servicio solicitado</p>
                                                        </div>
                                                    </div>
                                                    <textarea name="falla_cliente" rows="4"
                                                        class="w-full textarea textarea-bordered border-blue-200 focus:border-blue-900 text-lg font-bold text-blue-900 shadow-inner"
                                                        placeholder="Escriba el motivo aquí..."
                                                        required>{{ isset($cita) ? $cita->motivo_cita : '' }}</textarea>
                                                </div>

                                                <!-- Daños Section -->
                                                <div id="section-danos"
                                                    class="scroll-mt-32 bg-white p-8 rounded-2xl shadow-sm border border-blue-100 flex flex-col">
                                                    <div class="flex items-center justify-between mb-6">
                                                        <div>
                                                            <h3
                                                                class="font-black text-blue-900 tracking-tight leading-none uppercase flex items-center gap-2">
                                                                <i class="fas fa-car-crash text-blue-600"></i> Reporte de Daños
                                                            </h3>
                                                            <p class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-1">Marque golpes o
                                                                rayones (X)</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                                                        ...
                                                        <div class="lg:col-span-8">
                                                            <div class="grid grid-cols-2 gap-3 mb-4">
                                                                <button type="button" id="btnDamageCamera"
                                                                    class="btn btn-sm bg-blue-900 hover:bg-blue-800 text-white border-none shadow-md gap-2 py-4 h-auto">
                                                                    <i class="fas fa-camera"></i> CAMARA DE DAÑOS
                                                                </button>
                                                                <label for="damageImageUpload"
                                                                    class="btn btn-sm btn-outline border-blue-900 text-blue-900 hover:bg-blue-900 hover:text-white gap-2 py-4 h-auto">
                                                                    <i class="fas fa-cloud-upload-alt"></i> SUBIR REPORTE
                                                                </label>
                                                                <input type="file" id="damageImageUpload" accept="image/*" class="hidden" />
                                                            </div>

                                                            <div class="relative w-full aspect-video bg-slate-100 rounded-2xl border-2 border-dashed border-slate-300 overflow-hidden group mb-6 shadow-inner"
                                                                id="canvasContainer">
                                                                <div id="canvasPlaceholder"
                                                                    class="absolute inset-0 flex flex-col items-center justify-center text-slate-300 group-hover:text-blue-500 transition-colors pointer-events-none">
                                                                    <i class="fas fa-car-side text-7xl mb-4 opacity-20"></i>
                                                                    <span class="text-xs font-black uppercase tracking-widest">Toque para marcar daños sobre
                                                                        la foto</span>
                                                                </div>
                                                                <canvas id="damageCanvas"
                                                            ...
                                                            <div class="flex flex-col gap-3 relative z-20 bg-gray-50 p-4 rounded-xl border border-gray-100">
                                                                <div class="flex items-center justify-between">
                                                                    <div class="flex gap-2">
                                                                        <button type="button" id="undoMark"
                                                                            class="btn btn-sm btn-outline border-blue-900 text-blue-900 hover:bg-blue-900 hover:text-white gap-2 px-4 shadow-sm">
                                                                            <i class="fas fa-undo"></i> DESHACER
                                                                        </button>
                                                                        <button type="button" id="clearCanvas"
                                                                            class="btn btn-sm btn-ghost text-red-500 hover:bg-red-50 gap-2 font-black uppercase tracking-tighter">
                                                                            <i class="fas fa-broom"></i> LIMPIAR TODO
                                                                        </button>
                                                                    </div>
                                                                    <div class="flex gap-2">
                                                                        <button type="button" id="btnDeleteDamagePhoto"
                                                                            class="btn btn-sm btn-ghost text-red-600 gap-2 font-black uppercase tracking-tighter"
                                                                            title="Eliminar foto actual">
                                                                            <i class="fas fa-trash-alt"></i>
                                                                        </button>
                                                                        <button type="button" id="addDamageToGallery"
                                                                            class="btn btn-sm bg-green-600 hover:bg-green-700 text-white border-none gap-2 px-6 font-black uppercase tracking-tighter shadow-lg transform hover:scale-105 active:scale-95 transition-all">
                                                        ...
                                                        <div class="lg:col-span-4 border-l border-gray-100 lg:pl-8">
                                                            <div class="flex items-center justify-between mb-6">
                                                                <h4
                                                                    class="text-xs font-black text-gray-500 uppercase tracking-widest flex items-center gap-2">
                                                                    <i class="fas fa-images text-blue-600"></i> Galería de Daños
                                                                </h4>
                                                                <div id="damageCountBadge"
                                                                    class="badge bg-blue-900 text-white border-none text-[10px] font-black px-3 py-3">0
                                                                    FOTOS</div>
                                                            </div>
                                                            <div id="previewDanosGrid" class="grid grid-cols-1 sm:grid-cols-2 gap-4 min-h-[300px]">
                                                                <div id="emptyDanosMsg"
                                                                    class="col-span-full flex flex-col items-center justify-center p-12 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 opacity-60">
                                                                    <i class="fas fa-camera-retro text-4xl text-gray-300 mb-3"></i>
                                                                    <span
                                                                        class="text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">Las
                                                                        fotos marcadas aparecerán aquí</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        @push('scripts')
        <<<<<<< HEAD
            @vite('resources/js/operaciones/ordenes/create.js')=======<script>
            window.serverData = {
            routes: {
            searchClients: "{{ route('panel.operaciones.citas.searchClients') }}",
            searchVehicles: "{{ route('panel.operaciones.citas.searchVehicles') }}",
