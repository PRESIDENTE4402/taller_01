                    ...
                    <div class="md:col-span-2 flex flex-col space-y-4">
                        ...
                        <div class="card bg-white border border-gray-200 flex-1 flex flex-col">
                            <div class="card-body p-4 flex flex-col h-full overflow-hidden">
                                ...
                                <div
                                    class="overflow-y-auto max-h-[300px] flex-1 border rounded-lg bg-gray-50 relative custom-scrollbar">
                ...
                data.trabajos.forEach(t => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td>
                            ...
                            <div class="text-[9px] font-bold text-gray-400 uppercase truncate max-w-[120px]">${vehiculo}</div>
                        </td>
                        <td>
                            <span class="badge ${badgeClass} border-none font-bold badge-sm uppercase mb-1">${t.tipo_actividad}</span>
                            <div class="text-xs text-gray-600 font-medium italic truncate max-w-[150px]" title="${t.descripcion}">${t.descripcion}</div>
                        </td>
                        <td>
                            <div class="flex items-center">
                                <span class="text-gray-500 font-black px-1">Q</span>
                                <input type="number" step="0.01" min="0" class="input input-bordered input-xs w-20 monto-trabajo font-mono font-black text-emerald-600 text-right bg-white shadow-sm" value="${montoCalculado.toFixed(2)}" onkeyup="recalcularTotal()" onchange="recalcularTotal()">
                            </div>
                            ${textoCalculo}
                        </td>
                    `;
